...
/**
 * @author Usama This class should be subclassed when using custom row layouts for list views. Using a view holder significantly optimizes list view
 *         loading because findViewById() is not called for each row in the layout after initialization has been completed. Elements in the list view
